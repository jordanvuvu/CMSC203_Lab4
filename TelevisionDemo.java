...
public class TelevisionDemo
	...
	/******************Task #5 Creating another instance of a Television****************/
		...
		//call to the accessor method to print that the tv is on
		System.out.print("A " + portable.getScreenSize() + " inch "+ portable.getManufacturer() + " has been turned on.");
		
		//prompt for user input to store into station
		System.out.print(" What channel do you want? ");
		station = keyboard.nextInt();
		...
		//Display current channel and volume by calling the accessor method 
